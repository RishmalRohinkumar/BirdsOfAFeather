...
public class StudentToCSVTranslatorTests {
    ...
    public void testCanvasCSV() {
        ...
        Student student = new Student(1, 1, "Bill", "https://lh3.googleusercontent.com/pw/AM-JKLXQ2ix4dg-PzLrPOSMOOy6M3PSUrijov9jCLXs4IGSTwN73B4kr-F6Nti_4KsiUU8LzDSGPSWNKnFdKIPqCQ2dFTRbARsW76pevHPBzc51nceZDZrMPmDfAYyI4XNOnPrZarGlLLUZW9wal6j-z9uA6WQ=w854-h924-no?authuser=0", "a4ca50b6-941b-11ec-b909-0242ac120002");
    ...
    public void testCanvas2CSV() {
        Student student = new Student(1, 1, "Frank", "none", "a4ca50b6-941b-11ec-b909-0242ac120002");
