...
public class SessionsTests{
    ...
    public void testSeparateSessions() throws Exception {
        ...
        Student student0 = new Student(0, 0, "Anthony", "", "A",false);
        db.studentDAO().insert(student0);
        Student student1 = new Student(1, 0, "Jerry", "", "B",false);
        db.studentDAO().insert(student1);
        Student student2 = new Student(2, 0, "Ben", "", "C",false);
        ...
        Student student3 = new Student(3, 2, "CSE 99", "", "D",false);
